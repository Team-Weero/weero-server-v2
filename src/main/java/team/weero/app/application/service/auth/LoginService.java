  ...
  public TokenResponse execute(LoginRequest request) {
    ...
    if (teacherOpt.isPresent()) {
      ...
      return TokenResponse.builder()
          .accessToken(
              jwtTokenProvider.generateAccessToken(teacher.getAccountId(), UserRole.TEACHER, null))
          .accessTokenExpiresAt(now.plusSeconds(jwtProperties.getAccessExp()))
          .refreshToken(
              jwtTokenProvider.generateRefreshToken(teacher.getAccountId(), UserRole.TEACHER, null))
