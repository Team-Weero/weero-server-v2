...
public class UpdateCounselRequestService implements UpdateCounselRequestUseCase {
    ...
    @Override
    public CounselRequestResponse execute(
            UUID id, UpdateCounselRequestRequest request, UUID userId) {
        ...
        CounselRequest updated =
                CounselRequest.builder()
                        .id(existing.getId())
                        .accessPassword(
                                request.accessPassword() != null
                                        ? request.accessPassword()
                                        : existing.getAccessPassword())
                        ...
                        .teacherId(
                                request.teacherId() != null ? request.teacherId() : existing.getTeacherId())
