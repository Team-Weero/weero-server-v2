...
public class CounselingController {
  ...
  public ResponseEntity<List<CounselingResponse>> getMyCounselingApplications(
  ...
  public ResponseEntity<List<CounselingResponse>> getCounselingApplicationsByTeacher(
      @PathVariable UUID teacherId) {
    List<CounselingResponse> applications =
        getCounselingApplicationsByTeacherUseCase.execute(teacherId);
    return ResponseEntity.ok(applications);
  }
}
