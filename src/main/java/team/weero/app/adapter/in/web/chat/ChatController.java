...
public class ChatController {
  ...
  public ChatRoomResponse createChatRoom(
      @RequestBody @Valid CreateChatRoomRequest request, Authentication authentication) {
  ...
  public MessageResponse sendMessage(
      @RequestBody @Valid SendMessageRequest request, Authentication authentication) {
    return sendMessageUseCase.execute(request, authentication.getName());
  }

  @GetMapping("/rooms/{chatRoomId}/messages")
  public List<MessageResponse> getChatRoomMessages(
      @PathVariable UUID chatRoomId, Authentication authentication) {
