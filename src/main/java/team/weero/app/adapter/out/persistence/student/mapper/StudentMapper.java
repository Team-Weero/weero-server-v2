...
public class StudentMapper {
  ...
  public Student toDomain(StudentJpaEntity entity) {
    ...
    return Student.builder()
        ...
        .gcn(entity.getGcn())
        .role(
            team.weero.app.domain.student.model.StudentRole.valueOf(entity.getStudentRole().name()))
  ...
  public StudentJpaEntity toEntity(Student domain) {
    ...
    return StudentJpaEntity.builder()
        ...
        .gcn(domain.getGcn())
        .studentRole(
            team.weero.app.adapter.out.persistence.student.entity.StudentRole.valueOf(
                domain.getRole().name()))
        .build();
  }
}
