...
public class CounselingMapper {
  ...
  private team.weero.app.adapter.out.persistence.counseling.entity.CounselingLocation
      toPersistenceLocation(
          team.weero.app.domain.counseling.model.CounselingLocation domainLocation) {
    return team.weero.app.adapter.out.persistence.counseling.entity.CounselingLocation.valueOf(
        domainLocation.name());
  }

  private team.weero.app.domain.counseling.model.CounselingLocation toDomainLocation(
      team.weero.app.adapter.out.persistence.counseling.entity.CounselingLocation
          persistenceLocation) {
    return team.weero.app.domain.counseling.model.CounselingLocation.valueOf(
        persistenceLocation.name());
  }
}
