...
public class JwtTokenProvider {
  ...
  public JwtTokenProvider(
    ...
    this.secretKeySpec =
        new SecretKeySpec(
            jwtProperties.getSecretKey().getBytes(), SignatureAlgorithm.HS256.getJcaName());
  }

  public String generateToken(
      String accountId, String type, Long exp, UserRole userRole, StudentRole studentRole) {
  ...
  public String generateRefreshToken(String accountId, UserRole userRole, StudentRole studentRole) {
    String refreshToken =
        generateToken(accountId, "refresh", jwtProperties.getRefreshExp(), userRole, studentRole);
  ...
  public Authentication authentication(String token) {
    ...
    UserDetails userDetails =
        authDetailsService.loadUserByUsername(accountId, userRole, studentRole);
