...
public interface AuthRepository {
     ...
     */
    Optional<team.weero.app.infrastructure.persistence.student.entity.StudentJpaEntity> findStudentWithUserByAccountId(String accountId);
     ...
     */
    Optional<team.weero.app.infrastructure.persistence.teacher.entity.TeacherJpaEntity> findTeacherByAccountId(String accountId);
     ...
     */
    team.weero.app.infrastructure.persistence.teacher.entity.TeacherJpaEntity saveTeacher(team.weero.app.infrastructure.persistence.teacher.entity.TeacherJpaEntity teacher);
}
